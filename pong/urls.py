...
urlpatterns = [
    ...
    path("game/<int:gameId>/get-score/", views.get_scores),
    path("tournament/<int:tournamentId>/get-fourUsernames/", views.get_fourUsernames),
    path("game/<int:tournamentId>/get-fourScores/", views.get_fourScores),
]
