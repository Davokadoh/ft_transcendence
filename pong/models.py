...
class Game(models.Model):
    ...
    opponent = models.ForeignKey(User, on_delete=models.CASCADE, related_name='opponent_games', null=True)
    score = models.CharField(max_length=5, default="0 - 0")
    winner = models.ForeignKey(User, on_delete=models.CASCADE, null=True)
    result = models.CharField(max_length=4, choices=[('WIN', 'Win'), ('LOSE', 'Lose')], default='LOSE')
