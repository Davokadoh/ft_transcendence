			...
			<div class="container_opt">
				<div class="container-option">
					<form>
						...
						<br>
						<button type="button" class="btn bg-vert" data-toggle="modal" data-target="#featsModal">
							Feats</button>
						<img src="/src/img/feats.png" alt="Feats Icon" class="icon iconeF">
						<br>
						<button type="button" class="btn bg-vert" data-toggle="modal" data-target="#matchModal">
