...
var ListboxItem = (0, import_system2.forwardRef)((props, _) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Component, { ...getItemProps(), children: [
    ...
    isSelectable && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { ...getSelectedIconProps(), children: selectedContent }),
    endContent
  ] });
});
...
function Listbox(props, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...getBaseProps(), children: [...state.collection].map((item) => {
    var _a;
    const itemProps = {
      color,
      disableAnimation,
