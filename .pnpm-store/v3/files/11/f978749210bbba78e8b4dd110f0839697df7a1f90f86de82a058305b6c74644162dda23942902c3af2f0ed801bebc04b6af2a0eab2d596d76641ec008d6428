...
var PopoverContent = (0, import_system.forwardRef)((props, _) => {
  ...
  const arrowContent = (0, import_react.useMemo)(() => {
    if (!showArrow)
      return null;
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, { ...getDialogProps((0, import_utils.mergeProps)(dialogProps, otherProps)), ref: dialogRef, children: typeof children === "function" ? children(titleProps) : children }),
    arrowContent,
