...
var PopoverTrigger = (0, import_system3.forwardRef)((props, _) => {
  ...
  const { onPress, ...rest } = (0, import_react5.useMemo)(() => {
  ...
  return (0, import_react5.cloneElement)(child, (0, import_utils3.mergeProps)(rest, hasNextUIButton ? { onPress } : buttonProps));
});
...
var PopoverContent = (0, import_system4.forwardRef)((props, _) => {
  ...
  const arrowContent = (0, import_react6.useMemo)(() => {
    if (!showArrow)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { ...getArrowProps() });
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Component, { ...getDialogProps((0, import_utils4.mergeProps)(dialogProps, otherProps)), ref: dialogRef, children: typeof children === "function" ? children(titleProps) : children }),
    arrowContent,
...
var FreeSoloPopoverWrapper = ({
  ...
  return disableAnimation ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { ...otherProps, children }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
...
var FreeSoloPopover = (0, import_system5.forwardRef)((props, ref) => {
  ...
  const arrowContent = React2.useMemo(() => {
    if (!showArrow)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { ...getArrowProps() });
  }, [showArrow, getArrowProps]);
