...
var FreeSoloPopoverWrapper = ({
  ...
  return disableAnimation ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...otherProps, children }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
var FreeSoloPopover = (0, import_system2.forwardRef)((props, ref) => {
  const {
    Component,
    state,
    children,
